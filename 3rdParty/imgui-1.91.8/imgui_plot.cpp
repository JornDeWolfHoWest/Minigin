...
namespace ImGui {
// [0..1] -> [0..1]
static float rescale(float t, float min, float max, PlotConfig::Scale::EventType type) {
    switch (type) {
...
// [0..1] -> [0..1]
static float rescale_inv(float t, float min, float max, PlotConfig::Scale::EventType type) {
    switch (type) {
    case PlotConfig::Scale::Linear:
        return t;
    case PlotConfig::Scale::Log10:
